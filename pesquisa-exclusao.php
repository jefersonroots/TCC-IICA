      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <?php
								...
								$res = $inicio +10;
								$num_total = $conn->query("SELECT * FROM patrimonio where idpatrimonio in( ".$pesquisar.") ")->num_rows;// responsavel por trazer o numero de registros por pesquisa
								...
								while($row_exclusao = mysqli_fetch_assoc($resultado_pesquisa)){                                                                  
												print "<tbody>";
												print "<tr>";

												$data_bd = $row_exclusao["dt_compra"];
												$data_bd1 = $row_exclusao["data_exclusao"];
												...
												print "<td>".$row_exclusao["idpatrimonio"]."</td>";
												print "<td>".$row_exclusao["num_ativo_sede"]."</td>";
											   print "<td>".$row_exclusao["descricao_tipo"]."</td>";
												print "<td>".$row_exclusao["descricao_ativo"]."</td>";
											   print "<td >".$row_exclusao["descricao_item_compra"]."</td>";
												print "<td>".$row_exclusao["condicao"]."</td>";
												print "<td>".$data_brasileira."</td>";
												print "<td>".$data_brasileira1."</td>";
												//print "<td>".$dt_compra ."</td>";
												//print "<td>" .$data_exclusao."</td>";
												print "<td>".$row_exclusao["valor_item_compra"]."</td>";
												print "<td>".$row_exclusao["taxa_dolar"]."</td>";
												print "<td>".$row_exclusao["valor_dolar_item_compra"]."</td>";
												print "<td>".$row_exclusao["descricao_fundo"]."</td>";
												print "<td>".$row_exclusao["nome_projeto"]."</td>";	
												print "<td>".$row_exclusao["nome_funcionario"]."</td>";
												print "<td>".$row_exclusao["descricao_localizacao"]."</td>";
												print "<td>".$row_exclusao["observacao"]."</td>";
                    ...
                    echo "<footer class='sticky-footer bg-white'>";
                      echo "<div class='container my-auto'>";
                        echo "<div class='copyright text-center my-auto' >";
                          echo "<button class='btn btn-danger' type='button' onclick=\"if(confirm('Tem certeza que deseja excluir?')){location.href='salvar-patrimonio.php?page=salvar-patrimonio&acao=excluDE&num_ativo=".$pesquisar."';}else{false;}\">";
                            echo "<i class='fas fa-trash-alt fa-3x'></i>";
                          echo "</button>";
                        echo "</div>";
                      echo "</div>";
                    echo "</footer>";
