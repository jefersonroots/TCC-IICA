    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
          ...
          <button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle mr-3">
            <i class="fa fa-bars"></i>
                  ...
                  <!-- busca está aqui!!! --><br><br><br>
                        <div class="col">    
                          <div class="col-lg-7">                                    
                            <form class="user" method="POST"  action="pesquisa-coluna.php">
                              <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                  ...
                                  <select id='select' name="select_niveis_acesso" class="form-control " placeholder="Selecione">
                                      ...
                                      <option value="idpatrimonio">N° do ativo</option> 
                                        <option value="num_ativo_sede">Nº do ativo SEDE</option>
                                              <option value="descricao_tipo">Tipo de Ativo</option>
                                              <option value="descricao_ativo">Ativo Móvel</option>
                                              <option value="descricao_item_compra">Descrição Completa</option>
                                              <option value="condicao">Situação Ativo</option>                                         
                                              <option value="valor_item_compra">Valor R$</option>
                                              <option value="taxa_dolar">Taxa U$</option>
                                              <option value="valor_dolar_item_compra">Valor em U$</option>
                                              <option value="descricao_fundo">Fundo</option>
                                              <option value="nome_projeto">Projeto</option>
                                              <option value="nome_funcionario">Responsável	</option>
                                              <option value="descricao_localizacao">Localização	</option>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Lista Completa dos Bens</h1>
          ...
          <!-- DataTales Example -->
            <?php
              ...
              //$result_usuarios = "SELECT * FROM condicao where condicao like '%em uso%' LIMIT $inicio, $qnt_result_pg";

       
              $res = $inicio +10;
              $num_total = $conn->query("SELECT condicao_idcondicao FROM patrimonio where condicao_idcondicao = 3")->num_rows;
           ...
           $query = " SELECT idpatrimonio,num_ativo_sede,idtipo_ativo,descricao_tipo,descricao_ativo,descricao_item_compra,condicao,dt_compra,data_exclusao,
         ...
         $resultadofull = mysqli_query($conn, $query);


              while($row_full = mysqli_fetch_array($resultadofull)){   
                      ...
                      $data_bd = $row_full["dt_compra"];
                      $data_bd1 = $row_full["data_exclusao"];
                  ...
                  //   echo "$data_timestamp1<br>";
                      ...
                      print "<td>".$row_full["idpatrimonio"]."</td>";
                      print "<td>".$row_full["num_ativo_sede"]."</td>";
                     print "<td>".$row_full["descricao_tipo"]."</td>";
                      print "<td>".$row_full["descricao_ativo"]."</td>";
                     print "<td >".$row_full["descricao_item_compra"]."</td>";
                      print "<td>".$row_full["condicao"]."</td>";
                      print "<td>".$data_brasileira."</td>";
                      print "<td>".$data_brasileira1."</td>";
                      //print "<td>".$dt_compra ."</td>";
                      //print "<td>" .$data_exclusao."</td>";
                      print "<td>".$row_full["valor_item_compra"]."</td>";
                      print "<td>".$row_full["taxa_dolar"]."</td>";
                      print "<td>".$row_full["valor_dolar_item_compra"]."</td>";
                      print "<td>".$row_full["descricao_fundo"]."</td>";
                      print "<td>".$row_full["nome_projeto"]."</td>";	
                      print "<td>".$row_full["nome_funcionario"]."</td>";
                      print "<td>".$row_full["descricao_localizacao"]."</td>";
                      print "<td>".$row_full["observacao"]."</td>";
                      print "<td>
                      
                      <button class='btn btn-success' onclick=\"location.href='editar-categoria.php?&idpatrimonio=".$row_full["idpatrimonio"]."'\" ><i class='fas fa-user-edit'></i></button>  
                      
                      <button class='btn btn-danger' onclick=\"if(confirm('Tem certeza que deseja excluir?')){location.href='salvar-patrimonio.php?page=salvar-patrimonio&acao=excluir&idpatrimonio=".$row_full["idpatrimonio"]."';}else{false;}\"><i class='fas fa-trash-alt'></i></button>
                      
                      <button class='btn btn-warning' onclick=\"location.href='visualisar.php?&idpatrimonio=".$row_full["idpatrimonio"]."'\" ><i class='fas fa-eye'></i></button> 
                      </td>";
              ...
              $result_pg = "SELECT COUNT(idativo) AS num_result FROM ativo where descricao_ativo like '%EM USO%'";
              ...
              $max_links = 2;
                echo "<a href='listar-patrimonio.php?pagina=1'>Primeira</a> ";
                
                for($pag_ant = $pagina - $max_links; $pag_ant <= $pagina - 1; $pag_ant++){
                  if($pag_ant >= 1){
                    echo "<a href='listar-patrimonio.php?pagina=$pag_ant'>$pag_ant</a> ";
                  }
                }
                ...
                for($pag_dep = $pagina + 1; $pag_dep <= $pagina + $max_links; $pag_dep++){
                  if($pag_dep <= $quantidade_pg){
                    echo "<a href='listar-patrimonio.php?pagina=$pag_dep'>$pag_dep</a> ";
                  }
                }
                
                echo "<a href='listar-patrimonio.php?pagina=$quantidade_pg'>Última</a>";
      ...
      <footer class='sticky-footer bg-white'>
        <div class='container my-auto'>         
          <div class='copyright text-center my-auto'>
            <button class='btn btn-danger' onclick="location.href='fpdf/lista-completa.php'">
