      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <?php
                ...
                $query_pesquisa = " SELECT idpatrimonio,num_ativo_sede,idtipo_ativo,descricao_tipo,descricao_ativo,descricao_item_compra,condicao,dt_compra,data_exclusao,
				...
				pa.observacao 
						 ...
						 WHERE  ".$select_niveis_acesso." like '".$pesquisar."'  "    ;
                								
								$resultado = mysqli_query($conn, $query_pesquisa);
								...
								while($row_pesq = mysqli_fetch_assoc($resultado)){                                                                  
									...
									$data_bd = $row_pesq["dt_compra"];
									$data_bd1 = $row_pesq["data_exclusao"];
									...
									print "<td>".$row_pesq["idpatrimonio"]."</td>";
									print "<td>".$row_pesq["num_ativo_sede"]."</td>";
								   print "<td>".$row_pesq["descricao_tipo"]."</td>";
									print "<td>".$row_pesq["descricao_ativo"]."</td>";
								   print "<td >".$row_pesq["descricao_item_compra"]."</td>";
									print "<td>".$row_pesq["condicao"]."</td>";
									print "<td>".$data_brasileira."</td>";
									print "<td>".$data_brasileira1."</td>";
									//print "<td>".$dt_compra ."</td>";
									//print "<td>" .$data_exclusao."</td>";
									print "<td>".$row_pesq["valor_item_compra"]."</td>";
									print "<td>".$row_pesq["taxa_dolar"]."</td>";
									print "<td>".$row_pesq["valor_dolar_item_compra"]."</td>";
									print "<td>".$row_pesq["descricao_fundo"]."</td>";
									print "<td>".$row_pesq["nome_projeto"]."</td>";	
									print "<td>".$row_pesq["nome_funcionario"]."</td>";
									print "<td>".$row_pesq["descricao_localizacao"]."</td>";
									print "<td>".$row_pesq["observacao"]."</td>";
									print "<td>
									
									<button class='btn btn-success' onclick=\"location.href='editar-categoria.php?&idpatrimonio=".$row_pesq["idpatrimonio"]."'\" ><i class='fas fa-user-edit'></i></button>  
									
									<button class='btn btn-danger' onclick=\"if(confirm('Tem certeza que deseja excluir?')){location.href='salvar-patrimonio.php?page=salvar-patrimonio&acao=excluir&idpatrimonio=".$row_pesq["idpatrimonio"]."';}else{false;}\"><i class='fas fa-trash-alt'></i></button>
									
									<button class='btn btn-warning' onclick=\"location.href='visualisar.php?&idpatrimonio=".$row_pesq["idpatrimonio"]."'\" ><i class='fas fa-eye'></i></button> 
									</td>";
									
								}} else {
									print "<script>alert('Sem dados compatíveis com a pesquisa');</script>";
								}
