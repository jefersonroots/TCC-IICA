          ...
          <div class="col-lg-7">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Termo de Doação</h1>
              </div>
              
              <form class="user" method="POST" action="fpdf/controle ativos/ativo-para-doacao.php">                
                    ...
                    <div class="form-group row">
                      ...
                      <label>Texto referente ao motivo da doação:</label>
                        <input type="text" name="texto" class="form-control " id="exampleFirstName" placeholder="">
                      </div> 
                      <div class="col-sm-6">
                        <label>Número de páginas dos ativos a serem doados:</label>
