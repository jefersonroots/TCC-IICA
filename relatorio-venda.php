          ...
          <div class="col-lg-7">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Termo de Venda</h1>
              </div>
              
              <form class="user" method="POST" action="fpdf/controle ativos/termo-de-venda.php">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-6">
                      <label>CPF Representante IICA:</label>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-6">
                      <label>CNPJ ou CPF do representante da instituição beneficiada::</label>
                        <input type="text" name="cnpj" class="form-control " id="exampleFirstName" placeholder="">
                      </div> 
                    </div> 
                    <div class="form-group row">
                      <div class="col-sm-6 mb-6 mb-sm-0">
                      <label>Nome da instituição beneficiada:</label><BR><BR>
                        <input type="text" name="contemplado" class="form-control " id="exampleFirstName" placeholder="">
                      
                      </div> 
                      <div class="col-sm-6">
                      <label>Número de páginas dos ativos a serem vendidos:</label>
